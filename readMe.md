...
This project is a complete authentication system that can be used as a starter code for creating any new application. <a href="" target="_blank">LIVE</a>
...
5. Run the application:
   - npm start.
6. Open your web browser and go to `http://localhost:4000` to access the application.
